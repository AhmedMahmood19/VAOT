...
def evaluate_phase_classification(ckpt_step, train_embs, train_labels, val_embs, val_labels, act_name, CLASSIFICATION_FRACTIONS,  writer=None, verbose=False):

    for frac in CLASSIFICATION_FRACTIONS:
        print(frac)
